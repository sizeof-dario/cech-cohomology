...
\begin{frame}
    ...
    \begin{definition}[Nervo]
        ...
        Si dice \textbf{nervo}, e si indica con $N(\mathcal{U})$, il complesso simpliciale astratto i cui vertici sono gli aperti del ricoprimento: $\Vertk(N(\mathcal{U}))=\mathcal{U}$, \pause e i cui simplessi sono le sottofamiglie finite di $\mathcal{U}$ a intersezione non vuota:
...
%    \pause
    ...
    \pause
    Siano $\mathcal{K}$ una classe diretta, $\mathcal{C}$ una categoria \textit{cocompleta} e $\{A_k,\varphi^k_j\}$ un sistema diretto in $\mathcal{C}$ su $\mathcal{K}$. \pause Se due sottoclassi di $\mathcal{K}$, siano esse $\mathcal{L}$ e $\mathcal{M}$, sono insiemi e \textbf{cofinali} in $\mathcal{K}$, allora
...
\begin{frame}{Proposizione}
        ...
        \begin{enumerate}
            ...
            ci siano due successioni esatte lunghe con natural connecting homomorphisms:
            {\scriptsize $$\cdots\rightarrow H^{q-1}(\mathcal{H})\xrightarrow{\Delta_{q-1}}H^q(\mathcal{F})\rightarrow H^q(\mathcal{G})\rightarrow H^q(\mathcal{H})\xrightarrow{\Delta_q}H^{q+1}(\mathcal{F})\rightarrow\cdots$$
            $$\cdots\rightarrow \check{H}^{q-1}(\mathcal{H})\xrightarrow{\Delta'_{q-1}}\check{H}^q(\mathcal{F})\rightarrow \check{H}^q(\mathcal{G})\rightarrow \check{H}^q(\mathcal{H})\xrightarrow{\Delta'_q}\check{H}^{q+1}(\mathcal{F})\rightarrow\cdots$$}
            \pause
...
\begin{frame}
    \begin{theorem}
        ...
        $$0\rightarrow\check{H}^0(\mathcal{F})\rightarrow\check{H}^0(\mathcal{G})\rightarrow\check{H}^0(\mathcal{H})\xrightarrow{\Delta'_0}\check{H}^1(\mathcal{F})\rightarrow\cdots$$ 
    \end{theorem}
    \pause
    \begin{block}{Lemma}
