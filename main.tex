...
\begin{frame}
    ...
    \begin{enumerate}
        ...
        \pause
        \item $\Sigma$ è un insieme di parti finite e non vuote di $\Vertk(K)$ chiamate \textbf{simplessi} e tale che
        \pause
        \begin{enumerate}[(i.)]
...
\begin{frame}
    ...
    \begin{definition}[Nervo]
        \pause
        Sia $\mathcal{U}$ un ricoprimento aperto di $X$ non contentente il vuoto. \pause
...
\begin{frame}
    ...
    \begin{definition}[Complesso dei gruppi di cocatene]
        ...
        \pause
        e, presa $f:\Sigma_q\rightarrow\bigcup_{\sigma\in\Sigma_q}\mathcal{F}\left(\bigcap\sigma\right)$ in $C^q(\mathcal{U},\mathcal{F})$: \pause
