...
\begin{frame}
    \begin{theorem}
        Sia $0\rightarrow \mathcal{F}\rightarrow\mathcal{G}\rightarrow\mathcal{H}\rightarrow 0$ è una successione esatta corta di fasci su uno spazio paracompatto. \pause Allora esiste una successione esatta
    ...
    \pause
    \begin{block}{Lemma}
        Sia $\mathcal{I}$ un fascio iniettivo. \pause Allora $$\check{H}^q(\mathcal{F})=0$$
